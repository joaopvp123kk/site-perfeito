    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
				...
				<div class="oie">
				<p><h1>Este clássico dos jogos de tiro se destaca por sua recriação intensa da Segunda Guerra Mundial, com missões baseadas em operações reais, como o famoso desembarque na Normandia durante o Dia D. O nível de realismo para a época capturou a brutalidade do combate e a tensão das missões.</h1></p>
				</div>
				<style>
					.oie {
						color: purple;
				...
				<img src="medal.png" alt="Imagem de Arizona Sunshine 2">
                <p><strong>Link do Jogo:</strong> 
                    <a href="https://www.ea.com/pt-br/games/medal-of-honor/medal-of-honor-allied-assault">
		...
		<div class="oie">
			<p><h1>Ao oferecer aos jogadores uma perspectiva direta do que era ser um soldado durante a guerra, Medal of Honor ajudou a estabelecer um padrão para jogos históricos e a despertar o interesse em aprender mais sobre o conflito. Ele continua sendo uma referência em jogos ambientados na Segunda Guerra Mundial.
			</h1></p>
			</div>
			<style>
				.oie {
