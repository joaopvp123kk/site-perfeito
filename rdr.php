...
<section class="page-top-section set-bg" data-setbg="img/page-top-bg/4.jpg">
    <div class="page-info">
        ...
        <div class="site-breadcrumb">
            ...
            <span>Red Dead Redemption 2 (2018)</span>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
				...
				<div class="oie">
				<p><h1>Ambientado no final do século XIX, Red Dead Redemption 2 mostra o declínio do Velho Oeste e a transição para a era moderna nos Estados Unidos. O jogo apresenta temas como industrialização, expansão ferroviária e as mudanças na vida dos povos indígenas e dos fora-da-lei. A atenção aos detalhes históricos, como armas da época, costumes e até a economia, constrói um mundo vivo e autêntico.</h1></p>
				</div>
				<style>
					.oie {
						color: purple;
				...
				<img src="rdr.png" alt="Imagem de Arizona Sunshine 2">
		...
		<div class="oie">
			<p><h1>A narrativa explora como a transição histórica afetou indivíduos e comunidades, proporcionando uma reflexão sobre o impacto da modernização em culturas tradicionais e marginais. A vastidão do mundo em 3D cria um palco perfeito para experimentar essa transformação de forma imersiva.
			</h1></p>
			</div>
			<style>
				.oie {
