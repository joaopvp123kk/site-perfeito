    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
				...
				<div class="oie">
				<p><h1>Focado na Primeira Guerra Mundial, Battlefield 1 oferece uma recriação fiel de cenários de batalha históricos, desde trincheiras na Europa até os desertos do Oriente Médio. O jogo não romantiza o conflito; em vez disso, apresenta o horror da guerra por meio de narrativas de personagens que representam diferentes lados e perspectivas.</h1></p>
				</div>
				<style>
					.oie {
						color: purple;
				...
				<img src="battlefield.png" alt="Imagem de Arizona Sunshine 2">
                <p><strong>Link do Jogo:</strong> 
                    <a href="https://store.steampowered.com/app/1238840/Battlefield_1/">
		...
		<div class="oie">
			<p><h1>Essa abordagem permite que os jogadores compreendam a complexidade do conflito, enquanto o nível de realismo nas armas, veículos e táticas cria uma experiência historicamente rica. O jogo também destaca a evolução tecnológica da guerra e o impacto humano por trás dos números.
			</h1></p>
			</div>
			<style>
				.oie {
