    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
				...
				<div class="oie">
				<p><h1>Este jogo combina um estilo visual artístico com uma recriação emocional da Primeira Guerra Mundial. Baseado em cartas reais de soldados, Valiant Hearts mostra o lado humano do conflito, destacando a vida de civis, combatentes e até mesmo animais. Ele aborda eventos históricos como a Batalha do Somme e o uso de gás venenoso.</h1></p>
				</div>
				<style>
					.oie {
						color: purple;
				...
				<img src="valiant.png" alt="Imagem de Arizona Sunshine 2">
                <p><strong>Link do Jogo:</strong> 
                    <a href="https://store.steampowered.com/app/260230/Valiant_Hearts_The_Great_War__Soldats_Inconnus__Mmoires_de_la_Grande_Guerre/">
		...
		<div class="oie">
			<p><h1>Embora não seja tão focado em ação como outros jogos, Valiant Hearts toca emocionalmente os jogadores, incentivando a empatia e o entendimento sobre os sacrifícios e tragédias da guerra. A simplicidade do design 3D contrasta com a profundidade da narrativa histórica.
			</h1></p>
			</div>
			<style>
				.oie {
